    ...
    <div className="flex min-h-screen bg-brand-900 text-slate-200">
      ...
      <aside className="fixed inset-y-0 left-0 flex w-[260px] flex-col border-r border-white/[0.06] bg-brand-950">
        ...
        <div className="px-4 pb-2 pt-2">
          <p className="px-3 text-[11px] font-semibold uppercase tracking-wider text-slate-600">Menu</p>
        </div>
        ...
        <div className="border-t border-white/[0.06] p-4">
          ...
          <button
            ...
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-xl border border-white/[0.06] px-3 py-2 text-sm font-medium text-slate-400 transition hover:bg-white/[0.04] hover:text-slate-200"
          >
            Sign out
          </button>
        </div>
      ...
      <main className="ml-[260px] flex-1">
        <header className="sticky top-0 z-30 flex items-center justify-between border-b border-white/[0.06] bg-brand-900/80 px-4 py-4 backdrop-blur-xl lg:px-6">
          <div>
            <p className="text-xs font-medium text-slate-500">{panelName}</p>
            <h1 className="text-xl font-semibold tracking-tight text-white">{currentLabel}</h1>
          </div>
          <div className="flex items-center gap-3">
            <div className="hidden items-center gap-2 rounded-xl border border-white/[0.06] bg-white/[0.03] px-3 py-2 md:flex">
